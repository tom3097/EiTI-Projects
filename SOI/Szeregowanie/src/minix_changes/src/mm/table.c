...
_PROTOTYPE (int (*call_vec[NCALLS]), (void) ) = {
	...
	do_reboot,	/* 76 = reboot	*/
	do_svrctl,	/* 77 = svrctl	*/
	do_getpri,	/* 78 = do_getpri */
	do_setpri,	/* 79 = do_setpri */
	do_getsizef,	/* 80 = do_getsizef */
	do_getsizes,	/* 81 = do_getsizes */
	do_getheadnr,	/* 82 = do_getheadnr */
	do_getheadpid,	/* 83 = fo_getheadpid */
};
