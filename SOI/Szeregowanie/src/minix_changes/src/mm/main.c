...
PUBLIC int do_getsizef()
{
  message m;
  m = mm_in;
  return _taskcall(SYSTASK,SYS_GETSIZEF,&m);
}

PUBLIC int do_getsizes()
{
  message m;
  m = mm_in;
  return _taskcall(SYSTASK,SYS_GETSIZES,&m);
}

PUBLIC int do_getheadnr()
{
  message m;
  m = mm_in;
  return _taskcall(SYSTASK,SYS_GETHEADNR,&m);
}

PUBLIC int do_getheadpid()
{
  message m;
  m = mm_in;
  return _taskcall(SYSTASK,SYS_GETHEADPID,&m);
}
